...
* Notes: main.cpp are the only exectuable file and will print the content of bad-code.cpp in both properly formatted as the lab stated and without leading spaces as the lab stated.

I did not make use of doctest in this lab
